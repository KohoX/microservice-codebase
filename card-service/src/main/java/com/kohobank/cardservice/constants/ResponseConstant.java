package com.kohobank.cardservice.constants;
...
public final class ResponseConstant {
    ...
    public static ResponseDto expectationFailed(){
        return new ResponseDto(ResponseCodesAndMessages.EXPECTATION_FAILED, ResponseCodesAndMessages.EXPECTATION_FAILED_MESSAGE);
    }
